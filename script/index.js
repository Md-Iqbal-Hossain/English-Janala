...
const displayWordDetails = (word) => {
    ...
    <div class="">
                    <h2 class="tex-2xl font-bold">${word.word} (<i class="fa-solid fa-microphone-lines"></i>     :${word.pronunciation})</h2>
                </div>
                <div class="">
...
const displayLevelWord = (words) => {
    ...
    if (words.length == 0) {
        ...
        <img class = 'mx-auto' src = 'assets/alert-error.png'/>
            ...
            <h2 class="font-bold text-2xl md:text-4xl">নেক্সট Lesson এ যান</h2>
        </div>`;
        manageSpinner(false);
        return;
    }
